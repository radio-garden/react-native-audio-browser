...
export class OptionsManager {
  ...
  /**
   * Gets the progress update event interval.
   */
  getProgressUpdateEventInterval(): number | null {
    return this.options.progressUpdateEventInterval ?? null
  }

  /**
   * Gets the forward jump interval.
   */
  getForwardJumpInterval(): number {
    return this.options.forwardJumpInterval ?? 15
  }

  /**
   * Gets the backward jump interval.
   */
  getBackwardJumpInterval(): number {
    return this.options.backwardJumpInterval ?? 15
  }
}
