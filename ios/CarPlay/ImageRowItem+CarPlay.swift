...
extension ImageRowItem {
  ...
  func toTrack() -> Track {
    Track(
      id: nil, url: url, src: nil, artwork: artwork.map { .first($0) },
      artworkSource: artworkSource, request: nil,
      artworkCarPlayTinted: nil, title: title, subtitle: nil, artist: nil,
      albumUrl: nil, album: nil, description: nil, genre: nil, duration: nil, style: nil,
