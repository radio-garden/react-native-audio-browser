  ...
  targets: [
    .target(
      ...
      sources: [
        ...
        "Player/PlaybackCoordinator+Cast.swift",
        "Cast/CastReSignBudget.swift",
        "Cast/CastStateResolver.swift",
        "Cast/CastStateCoalescer.swift",
        "Cast/CastRemoteStatusInterpreter.swift",
