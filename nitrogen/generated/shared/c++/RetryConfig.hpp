...
namespace margelo::nitro::audiobrowser {
  ...
  public:
    RetryConfig() = default;
    explicit RetryConfig(std::optional<double> maxRetries, std::optional<double> maxRetryDurationMs): maxRetries(maxRetries), maxRetryDurationMs(maxRetryDurationMs) {}
