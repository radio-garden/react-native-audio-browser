///
/// BrowserSourceCallbackParam.hpp
...
namespace margelo::nitro::audiobrowser {
  ...
  /**
   * A struct which can be represented as a JavaScript object (BrowserSourceCallbackParam).
   */
  struct BrowserSourceCallbackParam final {
  public:
  ...
  public:
    friend bool operator==(const BrowserSourceCallbackParam& lhs, const BrowserSourceCallbackParam& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ BrowserSourceCallbackParam <> JS BrowserSourceCallbackParam (object)
  template <>
  struct JSIConverter<margelo::nitro::audiobrowser::BrowserSourceCallbackParam> final {
    static inline margelo::nitro::audiobrowser::BrowserSourceCallbackParam fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::audiobrowser::BrowserSourceCallbackParam(
        ...
        JSIConverter<std::optional<std::unordered_map<std::string, std::string>>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "routeParams")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::audiobrowser::BrowserSourceCallbackParam& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "routeParams"), JSIConverter<std::optional<std::unordered_map<std::string, std::string>>>::toJSI(runtime, arg.routeParams));
      return obj;
    }
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<std::unordered_map<std::string, std::string>>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "routeParams")))) return false;
      return true;
    }
  };
