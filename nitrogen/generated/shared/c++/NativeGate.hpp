...
namespace margelo::nitro::audiobrowser {
  ...
  /**
   * A struct which can be represented as a JavaScript object (NativeGate).
   */
...
namespace margelo::nitro {
  ...
  // C++ NativeGate <> JS NativeGate (object)
  template <>
  struct JSIConverter<margelo::nitro::audiobrowser::NativeGate> final {
    static inline margelo::nitro::audiobrowser::NativeGate fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
