...
namespace margelo::nitro::audiobrowser {
  ...
  public:
    BrowserLink() = default;
    explicit BrowserLink(std::optional<bool> playable, std::optional<std::string> url, std::string title, std::optional<std::string> subtitle, std::optional<std::string> icon, std::optional<std::string> artwork, std::optional<std::string> artist, std::optional<std::string> album, std::optional<std::string> description, std::optional<std::string> genre, std::optional<double> duration): playable(playable), url(url), title(title), subtitle(subtitle), icon(icon), artwork(artwork), artist(artist), album(album), description(description), genre(genre), duration(duration) {}
  };
