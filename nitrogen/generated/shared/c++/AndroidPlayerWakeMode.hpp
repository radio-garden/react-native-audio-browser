...
namespace margelo::nitro {
  ...
  // C++ AndroidPlayerWakeMode <> JS AndroidPlayerWakeMode (union)
  template <>
  struct JSIConverter<margelo::nitro::audiobrowser::AndroidPlayerWakeMode> final {
