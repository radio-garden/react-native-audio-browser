...
namespace margelo::nitro::audiobrowser {
   ...
   */
  struct PlayerCapabilities final {
  public:
  ...
  struct JSIConverter<margelo::nitro::audiobrowser::PlayerCapabilities> final {
    static inline margelo::nitro::audiobrowser::PlayerCapabilities fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::audiobrowser::PlayerCapabilities(
        JSIConverter<std::optional<bool>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "play"))),
        JSIConverter<std::optional<bool>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "pause"))),
        JSIConverter<std::optional<bool>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "stop"))),
        JSIConverter<std::optional<bool>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "seekTo"))),
        JSIConverter<std::optional<bool>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "skipToNext"))),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::audiobrowser::PlayerCapabilities& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "play"), JSIConverter<std::optional<bool>>::toJSI(runtime, arg.play));
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "pause"), JSIConverter<std::optional<bool>>::toJSI(runtime, arg.pause));
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "stop"), JSIConverter<std::optional<bool>>::toJSI(runtime, arg.stop));
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "seekTo"), JSIConverter<std::optional<bool>>::toJSI(runtime, arg.seekTo));
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "skipToNext"), JSIConverter<std::optional<bool>>::toJSI(runtime, arg.skipToNext));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<bool>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "play")))) return false;
      if (!JSIConverter<std::optional<bool>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "pause")))) return false;
      if (!JSIConverter<std::optional<bool>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "stop")))) return false;
      if (!JSIConverter<std::optional<bool>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "seekTo")))) return false;
      if (!JSIConverter<std::optional<bool>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "skipToNext")))) return false;
