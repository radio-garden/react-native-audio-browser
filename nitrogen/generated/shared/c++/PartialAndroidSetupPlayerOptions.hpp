...
namespace margelo::nitro::audiobrowser {
  ...
  public:
    ...
    explicit PartialAndroidSetupPlayerOptions(std::variant<bool, AndroidAudioOffloadSettings> audioOffload, std::optional<double> maxBuffer, std::optional<double> backBuffer, std::optional<double> playBuffer, std::optional<double> rebufferBuffer, std::optional<double> maxCacheSize, std::optional<AndroidAudioContentType> audioContentType, std::optional<bool> handleAudioBecomingNoisy, std::optional<AndroidPlayerWakeMode> wakeMode): audioOffload(audioOffload), maxBuffer(maxBuffer), backBuffer(backBuffer), playBuffer(playBuffer), rebufferBuffer(rebufferBuffer), maxCacheSize(maxCacheSize), audioContentType(audioContentType), handleAudioBecomingNoisy(handleAudioBecomingNoisy), wakeMode(wakeMode) {}
  };
