  ...
  struct JSIConverter<margelo::nitro::audiobrowser::SearchParams> final {
    static inline margelo::nitro::audiobrowser::SearchParams fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::audiobrowser::SearchParams(
        JSIConverter<std::optional<margelo::nitro::audiobrowser::SearchMode>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "mode"))),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::audiobrowser::SearchParams& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "mode"), JSIConverter<std::optional<margelo::nitro::audiobrowser::SearchMode>>::toJSI(runtime, arg.mode));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<margelo::nitro::audiobrowser::SearchMode>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "mode")))) return false;
