...
namespace margelo::nitro::audiobrowser {
  ...
  /**
   * A struct which can be represented as a JavaScript object (Gate).
   */
  struct Gate final {
  public:
  ...
  public:
    Gate() = default;
    explicit Gate(std::string title, std::optional<std::string> message): title(title), message(message) {}

  public:
    friend bool operator==(const Gate& lhs, const Gate& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ Gate <> JS Gate (object)
  template <>
  struct JSIConverter<margelo::nitro::audiobrowser::Gate> final {
    static inline margelo::nitro::audiobrowser::Gate fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::audiobrowser::Gate(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::audiobrowser::Gate& arg) {
