...
namespace margelo::nitro::audiobrowser {
  ...
  /**
   * A struct which can be represented as a JavaScript object (ImageContext).
   */
  struct ImageContext final {
  public:
  ...
  public:
    ...
    explicit ImageContext(std::optional<double> width, std::optional<double> height): width(width), height(height) {}

  public:
    friend bool operator==(const ImageContext& lhs, const ImageContext& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ ImageContext <> JS ImageContext (object)
  template <>
  struct JSIConverter<margelo::nitro::audiobrowser::ImageContext> final {
    static inline margelo::nitro::audiobrowser::ImageContext fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::audiobrowser::ImageContext(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::audiobrowser::ImageContext& arg) {
