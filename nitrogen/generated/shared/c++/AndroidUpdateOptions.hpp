...
namespace margelo::nitro::audiobrowser {
  ...
  /**
   * A struct which can be represented as a JavaScript object (AndroidUpdateOptions).
   */
  struct AndroidUpdateOptions {
  public:
  ...
  public:
    ...
    explicit AndroidUpdateOptions(std::optional<AppKilledPlaybackBehavior> appKilledPlaybackBehavior, std::optional<bool> skipSilence, std::optional<bool> shuffle, std::optional<RatingType> ratingType, std::optional<std::variant<nitro::NullType, NotificationButtonLayout>> notificationButtons): appKilledPlaybackBehavior(appKilledPlaybackBehavior), skipSilence(skipSilence), shuffle(shuffle), ratingType(ratingType), notificationButtons(notificationButtons) {}
  };
...
namespace margelo::nitro {
  ...
  // C++ AndroidUpdateOptions <> JS AndroidUpdateOptions (object)
  template <>
  struct JSIConverter<margelo::nitro::audiobrowser::AndroidUpdateOptions> final {
    static inline margelo::nitro::audiobrowser::AndroidUpdateOptions fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::audiobrowser::AndroidUpdateOptions(
