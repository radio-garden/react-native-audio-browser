...
namespace margelo::nitro::audiobrowser {
  ...
  public:
    ...
    explicit NitroAndroidUpdateOptions(std::optional<AppKilledPlaybackBehavior> appKilledPlaybackBehavior, std::optional<bool> skipSilence, std::optional<bool> shuffle, std::optional<RatingType> ratingType, std::optional<std::variant<nitro::NullType, std::vector<Capability>>> notificationCapabilities): appKilledPlaybackBehavior(appKilledPlaybackBehavior), skipSilence(skipSilence), shuffle(shuffle), ratingType(ratingType), notificationCapabilities(notificationCapabilities) {}
  };
