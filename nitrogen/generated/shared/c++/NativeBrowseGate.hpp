...
namespace margelo::nitro::audiobrowser {
  ...
  /**
   * A struct which can be represented as a JavaScript object (NativeBrowseGate).
   */
  struct NativeBrowseGate final {
  public:
  ...
  public:
    NativeBrowseGate() = default;
    explicit NativeBrowseGate(std::string title, std::optional<std::string> message, std::optional<std::string> buttonTitle): title(title), message(message), buttonTitle(buttonTitle) {}

  public:
    friend bool operator==(const NativeBrowseGate& lhs, const NativeBrowseGate& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ NativeBrowseGate <> JS NativeBrowseGate (object)
  template <>
  struct JSIConverter<margelo::nitro::audiobrowser::NativeBrowseGate> final {
    static inline margelo::nitro::audiobrowser::NativeBrowseGate fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::audiobrowser::NativeBrowseGate(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::audiobrowser::NativeBrowseGate& arg) {
