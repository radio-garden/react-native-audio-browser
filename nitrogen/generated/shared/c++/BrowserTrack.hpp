...
namespace margelo::nitro::audiobrowser {
  ...
  /**
   * A struct which can be represented as a JavaScript object (BrowserTrack).
   */
  struct BrowserTrack {
  public:
  ...
  public:
    BrowserTrack() = default;
    explicit BrowserTrack(std::string src, std::optional<std::string> url, std::string title, std::optional<std::string> subtitle, std::optional<std::string> icon, std::optional<std::string> artwork, std::optional<std::string> artist, std::optional<std::string> album): src(src), url(url), title(title), subtitle(subtitle), icon(icon), artwork(artwork), artist(artist), album(album) {}
  };
...
namespace margelo::nitro {
  ...
  // C++ BrowserTrack <> JS BrowserTrack (object)
  template <>
  struct JSIConverter<margelo::nitro::audiobrowser::BrowserTrack> final {
    static inline margelo::nitro::audiobrowser::BrowserTrack fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::audiobrowser::BrowserTrack(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::audiobrowser::BrowserTrack& arg) {
