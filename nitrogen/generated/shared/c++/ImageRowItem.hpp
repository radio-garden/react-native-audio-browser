...
namespace margelo::nitro::audiobrowser {
  ...
  public:
    ...
    explicit ImageRowItem(std::optional<std::string> id, std::optional<std::string> path, std::optional<std::string> src, std::optional<std::string> artwork, std::optional<ImageSource> artworkSource, std::string title, std::optional<std::string> artist, std::optional<std::string> album, std::optional<std::string> albumPath, std::optional<bool> live, std::optional<TrackRequest> request): id(id), path(path), src(src), artwork(artwork), artworkSource(artworkSource), title(title), artist(artist), album(album), albumPath(albumPath), live(live), request(request) {}
