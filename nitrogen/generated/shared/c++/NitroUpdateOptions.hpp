...
namespace margelo::nitro::audiobrowser {
  ...
  /**
   * A struct which can be represented as a JavaScript object (NitroUpdateOptions).
   */
  struct NitroUpdateOptions {
  public:
  ...
  public:
    NitroUpdateOptions() = default;
    explicit NitroUpdateOptions(std::optional<NitroAndroidUpdateOptions> android, std::optional<IOSUpdateOptions> ios, std::optional<double> forwardJumpInterval, std::optional<double> backwardJumpInterval, std::optional<std::variant<double, NullSentinel>> progressUpdateEventInterval, std::optional<std::vector<Capability>> capabilities): android(android), ios(ios), forwardJumpInterval(forwardJumpInterval), backwardJumpInterval(backwardJumpInterval), progressUpdateEventInterval(progressUpdateEventInterval), capabilities(capabilities) {}
  };
...
namespace margelo::nitro {
  ...
  // C++ NitroUpdateOptions <> JS NitroUpdateOptions (object)
  template <>
  struct JSIConverter<margelo::nitro::audiobrowser::NitroUpdateOptions> final {
    static inline margelo::nitro::audiobrowser::NitroUpdateOptions fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::audiobrowser::NitroUpdateOptions(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::audiobrowser::NitroUpdateOptions& arg) {
