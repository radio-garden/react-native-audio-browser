...
open class HybridAudioBrowserSpec_cxx {
   ...
   */
  @inline(__always)
  public func equals(other: HybridAudioBrowserSpec_cxx) -> Bool {
  ...
  public final var onSystemVolumeChanged: bridge.Func_void_double {
    @inline(__always)
    get {
      return { () -> bridge.Func_void_double in
        let __closureWrapper = Func_void_double(self.__implementation.onSystemVolumeChanged)
        return bridge.create_Func_void_double(__closureWrapper.toUnsafe())
      }()
    }
    @inline(__always)
    set {
      self.__implementation.onSystemVolumeChanged = { () -> (Double) -> Void in
  ...
  public final func add(tracks: bridge.std__vector_Track_, insertBeforeIndex: bridge.std__optional_double_) -> bridge.Result_void_ {
    do {
      try self.__implementation.add(tracks: tracks.map({ __item in __item }), insertBeforeIndex: { () -> Double? in
        if bridge.has_value_std__optional_double_(insertBeforeIndex) {
          let __unwrapped = bridge.get_std__optional_double_(insertBeforeIndex)
          return __unwrapped
        } else {
          return nil
        }
  ...
  public final func skip(index: Double, initialPosition: bridge.std__optional_double_) -> bridge.Result_void_ {
    do {
      try self.__implementation.skip(index: index, initialPosition: { () -> Double? in
        if bridge.has_value_std__optional_double_(initialPosition) {
          let __unwrapped = bridge.get_std__optional_double_(initialPosition)
          return __unwrapped
        } else {
          return nil
        }
  ...
  public final func skipToNext(initialPosition: bridge.std__optional_double_) -> bridge.Result_void_ {
    do {
      try self.__implementation.skipToNext(initialPosition: { () -> Double? in
        if bridge.has_value_std__optional_double_(initialPosition) {
          let __unwrapped = bridge.get_std__optional_double_(initialPosition)
          return __unwrapped
        } else {
  ...
  public final func skipToPrevious(initialPosition: bridge.std__optional_double_) -> bridge.Result_void_ {
    do {
      try self.__implementation.skipToPrevious(initialPosition: { () -> Double? in
        if bridge.has_value_std__optional_double_(initialPosition) {
          let __unwrapped = bridge.get_std__optional_double_(initialPosition)
          return __unwrapped
        } else {
    ...
    do {
      try self.__implementation.setQueue(tracks: tracks.map({ __item in __item }), startIndex: { () -> Double? in
        if bridge.has_value_std__optional_double_(startIndex) {
          let __unwrapped = bridge.get_std__optional_double_(startIndex)
          return __unwrapped
        } else {
          return nil
        }
  ...
  @inline(__always)
  public final func getSystemVolume() -> bridge.Result_double_ {
    do {
      let __result = try self.__implementation.getSystemVolume()
      let __resultCpp = __result
      return bridge.create_Result_double_(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
