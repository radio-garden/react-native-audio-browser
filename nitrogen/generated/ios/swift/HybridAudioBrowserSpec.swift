...
public protocol HybridAudioBrowserSpec_protocol: HybridObject {
  ...
  var onCarPlayConnectedChanged: (_ connected: Bool) -> Void { get set }
...
open class HybridAudioBrowserSpec_base {
  ...
  public func getCxxWrapper() -> HybridAudioBrowserSpec_cxx {
  #if DEBUG
    guard self is any HybridAudioBrowserSpec else {
    ...
    if let cxxWrapper = self.cxxWrapper {
      ...
      let cxxWrapper = HybridAudioBrowserSpec_cxx(self as! any HybridAudioBrowserSpec)
