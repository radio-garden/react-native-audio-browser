...
/**
 * Represents an instance of `NitroUpdateOptions`, backed by a C++ struct.
 */
public typealias NitroUpdateOptions = margelo.nitro.audiobrowser.NitroUpdateOptions

public extension NitroUpdateOptions {
  private typealias bridge = margelo.nitro.audiobrowser.bridge.swift

  /**
   * Create a new instance of `NitroUpdateOptions`.
   */
