...
public extension RequestConfig {
   ...
   */
  init(path: String?, baseUrl: String?, headers: Dictionary<String, String>?, query: Dictionary<String, Variant_Bool_String_Double>?, body: String?, contentType: String?, userAgent: String?) {
