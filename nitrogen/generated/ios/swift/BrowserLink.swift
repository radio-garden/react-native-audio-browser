...
/**
 * Represents an instance of `BrowserLink`, backed by a C++ struct.
 */
public typealias BrowserLink = margelo.nitro.audiobrowser.BrowserLink

public extension BrowserLink {
  private typealias bridge = margelo.nitro.audiobrowser.bridge.swift

  /**
   * Create a new instance of `BrowserLink`.
   */
  init(playable: Bool?, url: String?, title: String, subtitle: String?, icon: String?, artwork: String?, artist: String?, album: String?, description: String?, genre: String?, duration: Double?) {
