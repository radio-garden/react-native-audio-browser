...
/**
 * Wraps a Swift `(_ volume: Double) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_double {
  public typealias bridge = margelo.nitro.audiobrowser.bridge.swift

  private let closure: (_ volume: Double) -> Void

  public init(_ closure: @escaping (_ volume: Double) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(volume: Double) -> Void {
    self.closure(volume)
  }
