...
/**
 * Represents an instance of `TrackRequest`, backed by a C++ struct.
 */
public typealias TrackRequest = margelo.nitro.audiobrowser.TrackRequest

public extension TrackRequest {
  private typealias bridge = margelo.nitro.audiobrowser.bridge.swift

  /**
   * Create a new instance of `TrackRequest`.
   */
  init(userAgent: String?, headers: Dictionary<String, String>?, query: Dictionary<String, String>?) {
