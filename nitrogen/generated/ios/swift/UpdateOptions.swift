...
public extension UpdateOptions {
  ...
  var forwardJumpInterval: Double? {
    return { () -> Double? in
      if bridge.has_value_std__optional_double_(self.__forwardJumpInterval) {
        let __unwrapped = bridge.get_std__optional_double_(self.__forwardJumpInterval)
        return __unwrapped
      } else {
        return nil
      }
  ...
  var backwardJumpInterval: Double? {
    return { () -> Double? in
      if bridge.has_value_std__optional_double_(self.__backwardJumpInterval) {
        let __unwrapped = bridge.get_std__optional_double_(self.__backwardJumpInterval)
        return __unwrapped
      } else {
        return nil
      }
