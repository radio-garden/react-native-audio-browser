...
public extension UpdateOptions {
   ...
   */
  init(android: AndroidUpdateOptions?, forwardJumpInterval: Double?, backwardJumpInterval: Double?, progressUpdateEventInterval: Variant_NullType_Double?, capabilities: PlayerCapabilities?, iosPlaybackRates: [Double]?) {
