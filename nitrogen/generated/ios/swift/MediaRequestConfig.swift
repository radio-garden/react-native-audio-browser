...
/**
 * Represents an instance of `MediaRequestConfig`, backed by a C++ struct.
 */
public typealias MediaRequestConfig = margelo.nitro.audiobrowser.MediaRequestConfig

public extension MediaRequestConfig {
