...
/**
 * Represents an instance of `NativeBrowseGate`, backed by a C++ struct.
 */
public typealias NativeBrowseGate = margelo.nitro.audiobrowser.NativeBrowseGate

public extension NativeBrowseGate {
  private typealias bridge = margelo.nitro.audiobrowser.bridge.swift

  /**
   * Create a new instance of `NativeBrowseGate`.
   */
