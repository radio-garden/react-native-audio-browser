...
/**
 * Represents an instance of `NativeIOSSetupOptions`, backed by a C++ struct.
 */
public typealias NativeIOSSetupOptions = margelo.nitro.audiobrowser.NativeIOSSetupOptions

public extension NativeIOSSetupOptions {
  private typealias bridge = margelo.nitro.audiobrowser.bridge.swift

  /**
   * Create a new instance of `NativeIOSSetupOptions`.
   */
