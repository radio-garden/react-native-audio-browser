...
/**
 * Represents an instance of `BrowserTrack`, backed by a C++ struct.
 */
public typealias BrowserTrack = margelo.nitro.audiobrowser.BrowserTrack

public extension BrowserTrack {
  private typealias bridge = margelo.nitro.audiobrowser.bridge.swift

  /**
   * Create a new instance of `BrowserTrack`.
   */
  init(src: String, url: String?, title: String, subtitle: String?, icon: String?, artwork: String?, artist: String?, album: String?) {
