...
void registerAllNatives() {
  ...
  margelo::nitro::audiobrowser::JFunc_std__shared_ptr_Promise_std__variant_RequestConfig__std__shared_ptr_Promise_RequestConfig______RequestConfig_std__optional_std__unordered_map_std__string__std__string___cxx::registerNatives();
  margelo::nitro::audiobrowser::JFunc_std__shared_ptr_Promise_std__variant_TransformableRequestConfig__std__shared_ptr_Promise_TransformableRequestConfig______cxx::registerNatives();
  margelo::nitro::audiobrowser::JFunc_std__shared_ptr_Promise_std__variant_RequestConfig__std__shared_ptr_Promise_RequestConfig______Track_cxx::registerNatives();
  margelo::nitro::audiobrowser::JFunc_std__shared_ptr_Promise_std__variant_RequestConfig__std__shared_ptr_Promise_RequestConfig______MediaTransformParams_cxx::registerNatives();
