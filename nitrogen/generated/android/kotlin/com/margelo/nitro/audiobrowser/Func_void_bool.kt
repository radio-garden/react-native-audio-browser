...
/**
 * Represents the JavaScript callback `(online: boolean) => void`.
...
fun interface Func_void_bool: (Boolean) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(online: Boolean): Unit
}
...
class Func_void_bool_cxx: Func_void_bool {
  ...
  @FastNative
  private external fun invoke_cxx(online: Boolean): Unit
}
