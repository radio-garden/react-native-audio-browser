...
/**
 * Represents the JavaScript callback `(connected: boolean) => void`.
...
fun interface Func_void_bool: (Boolean) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(connected: Boolean): Unit
}
...
class Func_void_bool_cxx: Func_void_bool {
  ...
  @Keep
  override fun invoke(connected: Boolean): Unit
    = invoke_cxx(connected)

  @FastNative
  private external fun invoke_cxx(connected: Boolean): Unit
}
...
class Func_void_bool_java(private val function: (Boolean) -> Unit): Func_void_bool {
  ...
  @Keep
  override fun invoke(connected: Boolean): Unit {
    return this.function(connected)
  }
}
