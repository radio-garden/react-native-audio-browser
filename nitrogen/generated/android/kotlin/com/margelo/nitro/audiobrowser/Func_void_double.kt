...
/**
 * Represents the JavaScript callback `(volume: number) => void`.
...
fun interface Func_void_double: (Double) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(volume: Double): Unit
}
...
class Func_void_double_cxx: Func_void_double {
  ...
  @FastNative
  private external fun invoke_cxx(volume: Double): Unit
}
