...
namespace margelo::nitro::audiobrowser {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/audiobrowser/Func_void_std__string;";
  ...
  public:
    ...
    void invoke(const std::string& path) const {
      static const auto method = javaClassStatic()->getMethod<void(jni::alias_ref<jni::JString> /* path */)>("invoke");
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/audiobrowser/Func_void_std__string_cxx;";
