...
namespace margelo::nitro::audiobrowser {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "NitroUpdateOptions" and the the Kotlin data class "NitroUpdateOptions".
   */
  struct JNitroUpdateOptions final: public jni::JavaClass<JNitroUpdateOptions> {
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/audiobrowser/NitroUpdateOptions;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct NitroUpdateOptions by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    NitroUpdateOptions toCpp() const {
  ...
  public:
     ...
     */
    [[maybe_unused]]
    static jni::local_ref<JNitroUpdateOptions::javaobject> fromCpp(const NitroUpdateOptions& value) {
      return newInstance(
