...
namespace margelo::nitro::audiobrowser {
  ...
  public:
    ...
    static jni::local_ref<JNitroAndroidUpdateOptions::javaobject> fromCpp(const NitroAndroidUpdateOptions& value) {
      using JSignature = JNitroAndroidUpdateOptions(jni::alias_ref<JAppKilledPlaybackBehavior>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<JVariant_NullType_NotificationButtonLayout>);
      static const auto clazz = javaClassStatic();
