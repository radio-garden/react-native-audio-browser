...
namespace margelo::nitro::audiobrowser {
  ...
  public:
    ...
    static jni::local_ref<JUpdateOptions::javaobject> fromCpp(const UpdateOptions& value) {
      using JSignature = JUpdateOptions(jni::alias_ref<JAndroidUpdateOptions>, jni::alias_ref<JIOSUpdateOptions>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JDouble>, jni::alias_ref<JVariant_NullType_Double>, jni::alias_ref<JPlayerCapabilities>, jni::alias_ref<jni::JArrayDouble>);
      static const auto clazz = javaClassStatic();
