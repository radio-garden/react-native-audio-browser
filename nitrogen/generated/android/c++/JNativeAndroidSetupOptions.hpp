///
/// JNativeAndroidSetupOptions.hpp
...
namespace margelo::nitro::audiobrowser {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "NativeAndroidSetupOptions" and the the Kotlin data class "NativeAndroidSetupOptions".
   */
  struct JNativeAndroidSetupOptions final: public jni::JavaClass<JNativeAndroidSetupOptions> {
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/audiobrowser/NativeAndroidSetupOptions;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct NativeAndroidSetupOptions by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    NativeAndroidSetupOptions toCpp() const {
      ...
      return NativeAndroidSetupOptions(
  ...
  public:
     ...
     */
    [[maybe_unused]]
    static jni::local_ref<JNativeAndroidSetupOptions::javaobject> fromCpp(const NativeAndroidSetupOptions& value) {
      using JSignature = JNativeAndroidSetupOptions(jni::alias_ref<jni::JDouble>, jni::alias_ref<JVariant_Boolean_AndroidAudioOffloadSettings>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JDouble>, jni::alias_ref<JVariant_NullType_Double>, jni::alias_ref<jni::JDouble>, jni::alias_ref<JAndroidAudioContentType>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<JAndroidPlayerWakeMode>);
      static const auto clazz = javaClassStatic();
