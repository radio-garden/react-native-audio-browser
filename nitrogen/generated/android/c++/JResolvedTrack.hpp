...
namespace margelo::nitro::audiobrowser {
  ...
  public:
    ...
    static jni::local_ref<JResolvedTrack::javaobject> fromCpp(const ResolvedTrack& value) {
      using JSignature = JResolvedTrack(jni::alias_ref<jni::JString>, jni::alias_ref<jni::JArrayClass<JTrack>>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JString>, jni::alias_ref<JTrackStyle>);
      static const auto clazz = javaClassStatic();
