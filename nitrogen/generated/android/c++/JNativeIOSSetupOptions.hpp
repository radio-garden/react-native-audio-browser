...
namespace margelo::nitro::audiobrowser {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "NativeIOSSetupOptions" and the the Kotlin data class "NativeIOSSetupOptions".
   */
  struct JNativeIOSSetupOptions final: public jni::JavaClass<JNativeIOSSetupOptions> {
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/audiobrowser/NativeIOSSetupOptions;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct NativeIOSSetupOptions by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    NativeIOSSetupOptions toCpp() const {
  ...
  public:
     ...
     */
    [[maybe_unused]]
    static jni::local_ref<JNativeIOSSetupOptions::javaobject> fromCpp(const NativeIOSSetupOptions& value) {
      using JSignature = JNativeIOSSetupOptions(jni::alias_ref<jni::JDouble>, jni::alias_ref<JIOSCategory>, jni::alias_ref<JIOSCategoryMode>, jni::alias_ref<jni::JArrayClass<JIOSCategoryOptions>>, jni::alias_ref<JIOSCategoryPolicy>);
      static const auto clazz = javaClassStatic();
