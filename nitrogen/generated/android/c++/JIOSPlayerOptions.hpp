...
namespace margelo::nitro::audiobrowser {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "IOSPlayerOptions" and the the Kotlin data class "IOSPlayerOptions".
   */
  struct JIOSPlayerOptions final: public jni::JavaClass<JIOSPlayerOptions> {
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/audiobrowser/IOSPlayerOptions;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct IOSPlayerOptions by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    IOSPlayerOptions toCpp() const {
  ...
  public:
     ...
     */
    [[maybe_unused]]
    static jni::local_ref<JIOSPlayerOptions::javaobject> fromCpp(const IOSPlayerOptions& value) {
      return newInstance(
