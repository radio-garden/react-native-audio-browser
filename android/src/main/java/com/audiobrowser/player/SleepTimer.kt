 ...
 *
 * The timer stores the expiration time as a timestamp and uses a Handler to schedule
 * the completion callback. Supports both time-based and end-of-track modes.
 */
open class SleepTimer {
    ...
    /**
     * Sets the timer to complete when the current track finishes playing.
     * Note: The actual completion logic must be handled by the caller when the track ends.
     */
