 ...
 * starts from background will fail regardless of battery optimization status.
 */
object BatteryOptimizationHelper {
     ...
     *
     * For OPTIMIZED status: Shows a quick dialog to disable battery optimization (one tap).
     * For RESTRICTED status: Opens app settings where user must manually change battery setting.
     */
    ...
    /**
     * Show system dialog to request ignoring battery optimizations.
     * Only effective for OPTIMIZED status - won't remove background restrictions.
     */
    ...
    /**
     * Open the app's settings page where user can change battery restrictions.
     * Required for RESTRICTED status since the quick dialog won't help.
     */
